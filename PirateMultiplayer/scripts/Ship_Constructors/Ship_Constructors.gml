...
function create_ship(_ship = SHIP.SMALL, _team = TEAM.WHITE) constructor {
	sprites = new get_ship_sprites(_ship, _team);
	move = {
		acc : .5,
		maxSpeed : 1,
		turnSpeed : .3,
...
//	sprites = new get_ship_sprites(playerData.ship, playerData.team);
	
//}

function get_ship_sprites(_ship = SHIP.SMALL, _team = TEAM.WHITE) constructor{
	switch(_ship) {
		case SHIP.LARGE: 
			hull = spr_hull_large;
			break;
